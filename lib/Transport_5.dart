...
class Transport_5 extends StatefulWidget {
  final String demandeId;

  const Transport_5({Key? key, required this.demandeId}) : super(key: key);

  @override
  State<Transport_5> createState() => _Transport_5State();
}

class _Transport_5State extends State<Transport_5> {
        ...
        child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
              ...
              FirebaseFirestore.instance
                  ...
                  .then((soignantDoc) {
                    if (soignantDoc.exists) {
                      ...
                      soignant['endCoordinates'] = data['endCoordinates'];
                      soignant['demandeId'] = snapshot.data!.id;

                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Transport_6(soignant: soignant),
                        ),
                      );
                    } else {
            ...
            return Column(
              ...
              children: [
                Text(
                  "Nous recherchons un transport pour vous...",
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
