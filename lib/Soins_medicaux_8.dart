...
class Soins_medicaux_8 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Soins_medicaux_8({Key? key, required this.soignant}) : super(key: key);

  @override
  _Soins_medicaux_8State createState() => _Soins_medicaux_8State();
}

class _Soins_medicaux_8State extends State<Soins_medicaux_8> {
  double rating = 0;
  String comment = '';
