...
class Transport_8 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Transport_8({Key? key, required this.soignant}) : super(key: key);

  @override
  _Transport8State createState() => _Transport8State();
}

class _Transport8State extends State<Transport_8> {
  double rating = 0;
  String comment = '';
