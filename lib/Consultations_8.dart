...
class Consultations_8 extends StatefulWidget {
  final Map<String, dynamic> soignant;

  const Consultations_8({Key? key, required this.soignant}) : super(key: key);

  @override
  _Consultations_8State createState() => _Consultations_8State();
}

class _Consultations_8State extends State<Consultations_8> {
  double rating = 0;
  String comment = '';
