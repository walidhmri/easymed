...
class Analyses_medicales_5 extends StatefulWidget {
  final String demandeId;

  const Analyses_medicales_5({Key? key, required this.demandeId})
    : super(key: key);

  @override
  State<Analyses_medicales_5> createState() => _Analyses_medicales_5State();
}

class _Analyses_medicales_5State extends State<Analyses_medicales_5> {
                  ...
                  .then((soignantDoc) {
                    if (soignantDoc.exists) {
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              Analyses_medicales_6(soignant: soignant),
                        ),
                      );
                    } else {
